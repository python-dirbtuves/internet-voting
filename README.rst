.. note::
  ...
  This project was cancelled because we found that `Helios project`_ does exactly same thing as we do and does it much better. So if you are interested in full E2E verifiable internet voting protocol see the `Helios protocol`_.
